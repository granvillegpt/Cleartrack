# Practitioner Dashboard Header Rules

## Overview
This document defines the structure, styling, and behavior of the practitioner dashboard header for both desktop and mobile views. The mobile implementation uses Style 6 from `hamburger-menu-styles.html`.
...
- Implementation: `public/practitioner-dashboard.html`
- Related Rules: `PRACTITIONER_DASHBOARD_RULES.md`
